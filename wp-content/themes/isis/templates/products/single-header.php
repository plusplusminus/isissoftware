			...
			<div class="row">
				<div class="col-md-6">
					<div class="product_content">
						...
						<?php endif; ?>
						<?php $header_link = get_post_meta(15,'_ppm_header_link',true); ?>
						<?php if (!empty($header_link)) : ?>
							<div class="product_info--link">
								<a href="<?php echo $header_link; ?>" class="product_info--btn"><?php echo get_post_meta(15,'_ppm_header_text',true);?></a>
							</div>
						<?php endif; ?>
					</div>
				</div>
